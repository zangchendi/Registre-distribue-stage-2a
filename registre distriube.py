...
if __name__ == '__main__':
	...
	Peer('1.1.1.1', 'david', Peer_list, True)
	Peer('1.1.2.4', 'e', Peer_list, True)
	Peer('1.1.2.4', 'f', Peer_list, True)
	Peer('1.1.2.4', 'g', Peer_list, True)
	Peer('1.1.2.4', 'h', Peer_list, True)
	Peer('1.1.2.4', 'i', Peer_list, True)
	Peer('1.1.2.4', 'j', Peer_list, True)
	Peer('1.1.2.4', 'k', Peer_list, True)
